        ...
        <Fragment>
            <header className="absolute flex items-center justify-between px-5 py-8 w-full">
                ...
                {isOpen && (
                    ...
                    <ul className="bg-white shadow-2xl rounded-2xl py-3 md:bg-transparent md:shadow-none md:rounded-none md:py-0 md:flex">
                        ...
                        <li className="py-3 px-5 cursor-pointer md:px-0 md:py-0 md:border-none md:text-white md:mx-3">Get Started</li>
                    </ul>
                </nav>
                )}
